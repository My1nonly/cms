    ...
    <div id="bestdishes" class="container">
      ...
      <div class="slider">
      		    <ul class="slides">
          	 	 <li class="slide">
                    <div class="item">
                          <img src="{{ asset('images/thumb1.png') }}" width="226" height="225" alt="sliderimg" class="wow flipInX"
                           data-wow-delay=".8s"> 
                          <h3>Pasta Capellini</h3>
                      </div> <!-- end of item-->
                      
                   <div class="item2">
                          <img src="{{ asset('images/thumb2.jpg') }}" width="226" height="225" alt="sliderimg" class="wow flipInX"
                           data-wow-delay=".8s"> 
                          <h3>Pasta Pillus</h3>
                      </div> <!-- end of item-->
                      
                   <div class="item3">
                          <img src="{{ asset('images/thumb3.png') }}" width="226" height="225" alt="sliderimg" class="wow flipInX"
                           data-wow-delay=".8s"> 
                          <h3>Pasta Fusilli</h3>
                      </div> <!-- end of item-->
                  </li>
                   <li class="slide">
                    <div class="item">
                          <img src="{{ asset('images/thumb1.png') }}" width="226" height="225" alt="sliderimg" > 
                          <h3>Pasta Capellini</h3>
                      </div> <!-- end of item-->
                      
                   <div class="item2">
                          <img src="{{ asset('images/thumb2.jpg') }}" width="226" height="225" alt="sliderimg"> 
                          <h3>Pasta Pillus</h3>
                      </div> <!-- end of item-->
                      
                   <div class="item3">
                          <img src="{{ asset('images/thumb3.png') }}" width="226" height="225" alt="sliderimg"> 
                          <h3>Pasta Fusilli</h3>
                      </div> <!-- end of item-->
                  </li>
...
<div class="contactwrapper">
  <div id="contactus" class="container">
        ...
        <div class="staff">
       	  <ul>
                  <li><img src="{{ asset('images/char3.png') }}" width="163" height="163" class="myimage wow fadeIn" title="mido" alt="1">
                  
                  
            </li>
                  <li><img src="{{ asset('images/char4.png') }}" width="163" height="163" class="myimage2 wow fadeIn" data-wow-delay="0.8s"
                   alt="1"></li> 
                  <li><img src="{{ asset('images/char5.png') }}" width="163" height="163" class="myimage3 wow fadeIn" 
                  data-wow-delay="0.8s" 
                  alt="1"></li>
                  <li><img src="{{ asset('images/char6.png') }}" width="163" height="163" class="myimage4 wow fadeIn" alt="1"
                   data-wow-delay="0.8s"
                  ></li>
                  <li><img src="{{ asset('images/char1.png') }}" width="163" height="163" class="myimage5 wow fadeIn" alt="1"
                  data-wow-delay="0.8s"></li>
                  <li><img src="{{ asset('images/char2.png') }}" width="163" height="163" class="myimage6 wow fadeIn" alt="1"
                  data-wow-delay="0.8s"
                  ></li>
             </ul>   
    ...
    <img src="{{ asset('images/pop1.png') }}" width="486" height="137" class="firstpop" alt="pop">
    <img src="{{ asset('images/popup2.png') }}" width="487" height="137"  class="secondpop" alt="pop">
    <img src="{{ asset('images/popup3.png') }}" width="487" height="137"  class="thirdpop" alt="pop">
    <img src="{{ asset('images/popup4.png') }}" width="487" height="137"  class="fourthpop" alt="pop">  
    <img src="{{ asset('images/popup6.png') }}" width="487" height="137"  class="fifthpop" alt="pop">  
    <img src="{{ asset('images/popup7.png') }}" width="487" height="137"  class="sixthpop" alt="pop">  
